...
template <class T> class KMPLAYER_NO_EXPORT GlobalShared {
    T **global;
    int refcount;
public:
    GlobalShared (T **glob);
 ...
 */
template <class T>
class KMPLAYER_NO_EXPORT ListNodeBase : public Item <T> {
    friend class List<T>;
public:
 ...
 */
template <class T>
class KMPLAYER_NO_EXPORT ListNode : public ListNodeBase <ListNode <T> > {
public:
    ListNode (T d) : data (d) {}
    T data;
};
 ...
 */
template <class T>
class KMPLAYER_NO_EXPORT TreeNode : public ListNodeBase <T> {
public:
    void insertBefore (T *c, T *b);
 ...
 */
class KMPLAYER_NO_EXPORT Attribute : public ListNodeBase <Attribute> {
public:
...
struct KMPLAYER_NO_EXPORT VirtualVoid {
    virtual ~VirtualVoid () {}
};

struct KMPLAYER_NO_EXPORT KeyLoad : public VirtualVoid {
    KeyLoad (int ch) : key (ch) {}
    int key;
};

struct KMPLAYER_NO_EXPORT Connection {
...
class KMPLAYER_NO_EXPORT ConnectionLink {
#ifdef KMPLAYER_TEST_CONNECTION
public:
#endif
...
class KMPLAYER_NO_EXPORT ConnectionList {
#ifdef KMPLAYER_TEST_CONNECTION
public:
#endif
...
struct KMPLAYER_NO_EXPORT XMLStringlet {
    const QString str;
 ...
 */
class KMPLAYER_NO_EXPORT Node : public TreeNode <Node> {
...
public:
    ...
    virtual void clear ();
    void clearChildren ();
    using TreeNode<Node>::insertBefore;
    void insertBefore (QString &xml, Node *b);
...
const short id_node_download_document = 3;
const short id_node_download = 4;
const short id_node_text = 5;
const short id_node_cdata = 6;
const short id_node_ref_url = 7;

const short id_node_param = 15;
const short id_node_svg = 16;

const short id_node_group_node = 25;
const short id_node_playlist_document = 26;
const short id_node_playlist_item = 27;
const short id_node_html_object = 34;
const short id_node_html_embed = 35;

/*
 * Element node, XML node that can have attributes
 */
class KMPLAYER_NO_EXPORT Element : public Node {
public:
    ~Element ();
...
class KMPLAYER_NO_EXPORT PlaylistRole {
public:
    PlaylistRole () {}
...
class KMPLAYER_NO_EXPORT DescriptionRole {
public:
    QString description;
};
 ...
 */
class KMPLAYER_NO_EXPORT Mrl : public Element, public PlaylistRole
{
protected:
...
public:
    ...
    static QString *parsePanZoomString (const QString &pz, QString *coord);
 ...
 */
class KMPLAYER_NO_EXPORT PlayListNotify {
public:
...
class KMPLAYER_NO_EXPORT MrlBackEndNotify
{
public:
    virtual Mrl *sourceMrl () = 0;
    virtual void referenceMrl (const QString &url) = 0;
    virtual void infoMessage (const QString &msg) = 0;
    virtual void readyToPlay (Process *process) = 0;
};

/*
 *  A generic type for posting messages
 **/
class KMPLAYER_NO_EXPORT Posting {
public:
 ...
 */
class KMPLAYER_NO_EXPORT Document : public Mrl {
    friend class Postpone;
public:
    Document (const QString &, PlayListNotify * notify = 0L);
#ifdef _HARMATTAN
    Document (const QString &s, const QString &a, PlayListNotify * notify = 0L);
#endif
    ~Document ();
 ...
 */
class KMPLAYER_NO_EXPORT TextNode : public Node {
public:
 ...
 */
class KMPLAYER_NO_EXPORT CData : public TextNode {
public:
 ...
 */
class KMPLAYER_NO_EXPORT DarkNode : public Element {
public:
 ...
 */
class KMPLAYER_NO_EXPORT GenericURL : public Mrl {
public:
    GenericURL(NodePtr &d, const QString &s, const QString &n=QString ());
#ifdef _HARMATTAN
    GenericURL(NodePtr &d, const QString &s, const QString &a, const QString &n=QString ());
#endif
 ...
 * Non url mrl
 */
class KMPLAYER_NO_EXPORT GenericMrl : public Mrl {
public:
...
KMPLAYER_NO_EXPORT Node * fromXMLDocumentTag (NodePtr & d, const QString & tag);
