...
class KMPLAYER_NO_EXPORT Item : public Element, public PlaylistRole, public DescriptionRole {
public:
...
class KMPLAYER_NO_EXPORT Enclosure : public Mrl, public DescriptionRole {
public:
