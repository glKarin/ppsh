...
class KMPLAYER_NO_EXPORT TrieString {
    TrieNode * node;
...
public:
    ...
    static TrieString attr_panzoom;
    static TrieString attr_autoremove;
#ifdef _HARMATTAN
    static TrieString attr_audio;
#endif
};
